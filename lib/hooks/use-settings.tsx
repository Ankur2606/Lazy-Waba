...
class SettingsStore {
	...
	async loadGlobalSettings() {
		try {
			...
			// Set default values for realtime audio transcription settings
			const settingsWithDefaults = {
				...screenpipeSettings,
				enableRealtimeAudioTranscription: 
					screenpipeSettings.enableRealtimeAudioTranscription !== false ? true : false,
				realtimeAudioTranscriptionEngine: 
					screenpipeSettings.realtimeAudioTranscriptionEngine || "screenpipe-cloud"
			};
			
			this.setGlobalSettings(settingsWithDefaults);
